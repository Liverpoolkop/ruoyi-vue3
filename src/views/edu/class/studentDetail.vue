<template>
  <div class="class-detail-page">
    ...
    <!-- Dialogs -->
    <el-dialog v-model="importOpen" title="导入学生名单" width="520px" append-to-body>
      <el-upload 
        ref="uploadRef"
        :limit="1"
        accept=".xlsx, .xls"
...
import { UploadFilled, User, UserFilled, School, Collection, Plus, Upload, Delete, Key, Search, Close, InfoFilled } from '@element-plus/icons-vue'
import { getClass, inviteClass, batchAddStudents, removeStudent, getUserBrief, listClass } from '@/api/edu/class'
...
function submitAddStudents() {
  if (studentAddActiveTab.value === 'search') {
    ...
    getClass(selectedClassId.value).then(res => {
